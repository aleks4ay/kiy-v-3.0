...
public final class CopyOrderFrom1S {
...
//                System.out.println("4");
                if ( ! listOrder.containsKey(bigNumber) ) {
                    ps2 = conn2.prepareStatement(
                            "INSERT INTO orders (big_number, iddoc, idclient, idmanager, duration, docno, pos_count, client_name, manager_name, " +
...
//                    listOrder.put(bigNumber, newOrder);
                    ...
                    ps2 = conn2.prepareStatement("UPDATE orders SET iddoc = ?, idclient = ?, idmanager = ?, duration = ?, docno = ?, " +
